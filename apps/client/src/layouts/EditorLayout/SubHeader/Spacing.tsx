...
// export const Spacing = ({ onPropertyChange }: Props) => {
...
// 				([, property]) => property.category === 'Spacing' && (property as any).isDerived !== true
// 			)
// 		)
// 	}
...
// 					<Padded>
// 						<Title>
// 							{selectionKey === 'maxWidth' ? 'Set width of the page' : 'Set padding surrounding each Block'}
// 						</Title>
// 						<StylePropertyInput

...
// 	h3Size: boolean
// 	h3Weight: boolean
// 	headingsPadding: boolean
// }

// export const Headings = ({ onPropertyChange }: Props) => {
...
// 		h3Size: false,
// 		h3Weight: false,
// 		headingsPadding: false,
// 	})

// 	function filterObjectWithValues() {
// 		return Object.fromEntries(
// 			Object.entries(DEFAULT_STYLE_VALUES).filter(
// 				([, property]) => property.category === 'Headings' && (property as any).isDerived !== true
// 			)
// 		)
// 	}
...
// 		switch (type) {
// 			case 'h1Size':
// 				return 'Set font size of all H1 block'
// 			case 'h2Size':
// 				return 'Set font size of all H2 block'
// 			case 'h3Size':
// 				return 'Set font size of all H3 block'
// 			case 'h1Weight':
// 				return 'Set font weight of all H1 block'
// 			case 'h2Weight':
// 				return 'Set font weight of all H2 block'
// 			case 'h3Weight':
// 				return 'Set font weight of all H2 block'
// 			default:
// 				return 'Set Padding around all the Headings'
// 		}
// 	}

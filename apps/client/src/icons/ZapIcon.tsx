...
export const ZapIcon = ({ size = 24, color = 'black', style, fill = 'none' }: IconProps) => {
	return (
		<svg width={size} height={size} viewBox="0 0 24 24" fill={fill} xmlns="http://www.w3.org/2000/svg" style={style}>
			<path
